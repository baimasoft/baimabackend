...
from app.models import Application, User, Order
...
class UserView(ModelView, model=User):
    column_list = [User.id, User.username, User.phone_number,User.avatar,User.wxid,User.session_key,User.orders,User.created_at, User.updated_at]
...
def init_admin(app: FastAPI):
    ...
    admin.add_view(ApplicationView)